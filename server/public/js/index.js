...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(90), __webpack_require__(125)(module)))
...
var Calculate = function () {
    ...
    _createClass(Calculate, [{
        ...
        value: function computeBonus(active, play_name) {
            ...
            var self = this;
            var arr = new Array(play[i] * 1).fill(0);
            var min = void 0,
                max = void 0;
            if (play[0] === 'r') {
                var min_active = 5 - (11 - active);
                if (min_active > 0) {
                    if (min_active - play[i] >= 0) {
        ...
        value: function combine(arr, size) {
            ...
            (function f(arr, size, result) {
                ...
                if (size === arrLen) {
                    ...
                    for (var _i = 0; _i < arrLen.length; _i++) {
    ...
    _createClass(Timer, [{
        ...
        value: function countdown(end, update, handle) {
            ...
            if (now - end) {
                ...
                var h = Math.floor((last_time - d * pxd) / px_h);
